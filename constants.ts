...
export const PRODUCTS: Product[] = [
  {
    ...
    images: [
      {
        id: 101,
        src: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=75&w=600&auto=format&fit=crop",
        name: "Luminous Silk Serum",
        alt: "Luminous Silk Serum bottle"
      }
    ],
    rating: 4.9,
    reviews: 1240,
    ...
    short_description: "Serum ringan yang seketika mencerahkan dan menghidrasi."
  },
  {
    id: 2,
    ...
    images: [
      {
        id: 102,
        src: "https://images.unsplash.com/photo-1532453288672-3a27e9be9efd?q=75&w=600&auto=format&fit=crop",
        name: "The Structured Wool Coat",
        alt: "Woman wearing wool coat"
      }
    ],
    rating: 4.8,
    reviews: 320,
    ...
    short_description: "Sentuhan klasik bertemu minimalisme modern. Dibuat dari campuran wol premium."
  },
  {
    id: 3,
    ...
    images: [
      {
        id: 103,
        src: "https://images.unsplash.com/photo-1608248597279-f99d160bfbc8?q=75&w=600&auto=format&fit=crop",
        name: "Midnight Recovery Oil",
        alt: "Midnight Recovery Oil bottle"
      }
    ],
    rating: 5.0,
    reviews: 89,
    ...
    short_description: "Perbaiki dan regenerasi kulit saat Anda tidur."
  },
  {
    id: 4,
    name: "Sculptural Gold Hoops",
    slug: "sculptural-gold-hoops",
    price: 675000,
    category: "Perhiasan",
    ...
    images: [
      {
        id: 104,
        src: "https://images.unsplash.com/photo-1635767798638-3e25273a8236?q=75&w=600&auto=format&fit=crop",
        name: "Sculptural Gold Hoops",
        alt: "Gold Hoops Earrings"
      }
    ],
    rating: 4.7,
    reviews: 450,
    ...
    short_description: "Anting hoops vermeil emas 18k yang dirancang untuk keanggunan sehari-hari."
  },
  {
    id: 5,
    ...
    images: [
      {
        id: 105,
        src: "https://images.unsplash.com/photo-1586495777744-4413f21062fa?q=75&w=600&auto=format&fit=crop",
        name: "Velvet Matte Lipstick",
        alt: "Red Matte Lipstick"
      }
    ],
    rating: 4.6,
    reviews: 2100,
    ...
    short_description: "Warna berpigmen tinggi dengan hasil akhir matte yang nyaman."
  },
  {
    id: 6,
    ...
    images: [
      {
        id: 106,
        src: "https://images.unsplash.com/photo-1591561954557-26941169b49e?q=75&w=600&auto=format&fit=crop",
        name: "The Weekender Tote",
    ...
    short_description: "Tas tote kulit premium dengan ruang luas untuk kebutuhan esensial."
  }
];
